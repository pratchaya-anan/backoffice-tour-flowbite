        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <form action="#">
            ...
            <div class="grid gap-4 mb-4 mt-3 sm:grid-cols-4">
              ...
              <div>
                <label for="brand" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">แผนก</label>
            ...
            <div class="grid gap-4 mb-4 mt-3 sm:grid-cols-3">
              <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ราคา</label>
