            ...
            <div class="mt-3 overflow-x-auto">
              <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                ...
                >
                  ...
                  <tbody>
                    <tr
                      v-for="(datadis, indexd) in datarequisition"
                      :key="indexd"
          ...
          <form action="#">
            ...
            <div class="grid gap-4 mb-4 mt-3 sm:grid-cols-4">
              ...
              <div class="">
                ...
                <input
                  type="text"
                  v-model="insertclear.date_money"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                />
              </div>
              <div class="">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    datepicker-autohide
                    type="text"
                    v-model="insertclear.receipt_date"
            ...
            <div class="grid gap-4 mb-4 mt-3 sm:grid-cols-3">
              ...
              <div>
                ...
                <input
                  type="text"
                  v-model="insertclear.expense_type"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                />
              </div>
              <div>
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-5">
              ...
              >
                ...
                <tbody>
                  <tr
                    class="bg-gray-50 border-b dark:bg-gray-900 dark:border-gray-700"
                  >
