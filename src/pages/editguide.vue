<template>
  <section class="dark:bg-gray-900 p-3 sm:p-5 min-h-175">
    <div class="max-w-screen-lg mx-auto">
      ...
      <ol class="flex justify-end items-center w-full space-y-4">
        ...
        <NuxtLink to="/editguide">
          <div type="button"
            class="px-4 py-2 text-sm font-medium text-gray-900 bg-gray-200 border-t border-b  border-gray-200 ">
        ...
        <NuxtLink to="/editvehicle">
          <button type="button"
            class="px-4 py-2 text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-r-md hover:bg-gray-100 hover:text-blue-700  dark:focus:text-white">
            <li class="flex items-center text-gray-500 dark:text-gray-400 space-x-2.5">
              <svg fill="none" class="w-6 h-6 ml-2" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                <path stroke-linecap="round" stroke-linejoin="round"
      ...
      <div class="mt-3 block w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <form>
          ...
          <div class="mt-5">
            ...
            <div class="w-30">
              <button type="button" data-modal-target="addguide" data-modal-toggle="addguide"
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-for="(data, index) in datafil" key="index"
                  ...
                  <td class="px-6 py-4">
                    <a data-modal-target="deletetour" data-modal-toggle="deletetour" class="font-medium text-red-600 dark:text-red-500 hover:underline" >ลบ
                    </a>
                  </td>
                </tr>
              </tbody>
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 space-y-6">
            <div class="flex justify-between">
              ...
              <button type="button" data-modal-target="newguide" data-modal-toggle="newguide"
                ...
                <tbody>
                  <tr v-for="(data, index) in guidedata" key="index"
                    ...
                    <td class="flex items-center px-6 py-4 space-x-3">
                      <a data-modal-target="editguide" data-modal-toggle="editguide" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">แก้ไข</a>
          ...
          <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="addguide" type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">ตกลง</button>
            <button data-modal-hide="addguide" type="button"
    ...
    <!-- edit Guide -->
    <div id="editguide" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            ...
            <button data-modal-hide="editguide" type="button"
              class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">ยกเลิก</button>
          </div>
        </div>
      </div>
      ...
      <!-- New Guide -->
      <div id="newguide" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        <!-- Modal content -->
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
