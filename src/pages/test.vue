    ...
    <section class="h-min-160 bg-gray-100 dark:bg-gray-900">
        <div class="mx-auto max-w-screen-2xl px-4 lg:px-12 p-6">
            ...
            <form>
                ...
                <div class="flex justify-between mt-3">
                    ...
                    <button id="dropdown-button" data-dropdown-toggle="dropdown"
                        ...
                        type="button">สถานะ <svg aria-hidden="true" class="w-4 h-4 ml-1" fill="currentColor"
                    ...
                    <div id="dropdown"
                        ...
                        <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdown-button">
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">ทั้งหมด</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">รอคน</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">พร้อม</button>
                            </li>
                            <li>
                                <button type="button"
                                    class="inline-flex w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">เสร็จ</button>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-2 mt-3">
                <a href="/tourdata" v-for="(data, indexd) in tourdata" :key="indexd" @click="setid(data.idtour)" class="grid grid-cols-2 md:grid-cols-2 gap-1 block max-w-full p-4 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    <div>
                    ...
                    <div class="flex mt-0.5 ml-40"><svg class="w-7 h-7" fill="none" stroke="currentColor" stroke-width="1.5"
                    ...
                    <div>
                        <h5 class="mb-2 text-xl font-bold tracking-tight text-gray-900 dark:text-white">{{ data.tourname }}
                        </h5>
                    </div>
                    <div></div>
