<template>
  ...
  <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5 min-h-175">
      ...
      <div class="mt-3 block w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
        ...
        <form>
          <div class="grid gap-4 mb-4 grid-cols-5 mt-5">
            <div>
              <button type="button" data-modal-target="addhotel" data-modal-toggle="addhotel"
      ...
      <div class="relative w-full max-w-6xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div
            ...
            <button data-modal-hide="addhotel" type="button"
    ...
    <!-- Main modal newhotel-->
    <div id="newaddhothel" tabindex="-1" aria-hidden="true"
    ...
    <!-- edit Hotel -->
    <div id="edithotel" tabindex="-1" aria-hidden="true"
      class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
      <div class="relative p-4  max-w-2xl h-full md:h-auto">
        <!-- Modal content -->
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
