    ...
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5">
            ...
            <div class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
                ...
                <form>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                            <label for="small-input"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อไกด์</label>
                            <input type="text" id="small-input"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        </div>
                        <div class="grid gap-4 mb-4 grid-cols-4">
                            ...
                            <button type="button"
                                class="mt-7 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">เพิ่มไกล์</button>
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4 mt-4">
                        ...
                        <div date-rangepicker class="flex items-center col-span-2 mt-6">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4 ">
                        <div>
                            <label for="small-input"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">พาหนะอื่นๆ ขาไป</label>
                            <input type="text" id="small-input"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        </div>
                        <div>
                            <label for="small-input"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">พาหนะ ขากลับ</label>
                            <input type="text" id="small-input"
                                class="block w-full p-2 text-gray-900 border border-gray-300 rounded-lg bg-gray-50 sm:text-xs focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                        </div>
                        <div>
                    ...
                    <button type="button"
                        class="w-full px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">สร้างทัวร์</button>
                </form>
            </div>
        ...
        <div class="max-w-screen-xl mx-auto m-6">
            <div class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
                ...
                <form>
                    <div class="grid gap-4 mb-4 sm:grid-cols-4">
                        ...
                        <div date-rangepicker class="flex items-center col-span-2 mt-7">
                    ...
                    <div>
                        <button type="button"
                            class="w-full px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">เพิ่มโรงแรม</button>
                    </div>
                    <div class="mt-3">
            ...
            <div class="flex justify-end ">
                <button type="button"
                    class="mt-3 px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">บันทึกข้อมูล</button>
