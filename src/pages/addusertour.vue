<template>
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5 mb-10">
        <div
            class="mx-auto max-w-screen-xl mt-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 p-3">
                ...
                <form action="#">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                        ...
                        <div class="w-full flex items-center space-x-4">
                            ...
                            <button type="submit"
                                class="w-full mt-6 py-2.5 bg-blue text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                เพิ่มลูกทัวร์
                            </button>
                        </div>
                    </div>
