                ...
                <form action="#">
                    ...
                    <div class="grid gap-4 mb-4 sm:grid-cols-6 sm:gap-6 sm:mb-5">
                        ...
                        <div class="flex items-center space-x-4">
                            <button type="submit"
                                class="w-full mt-6 text-primary-500 bg-primary-100 hover:bg-primary-200 focus:ring-4 focus:outline-none focus:ring-primary-300 font-small rounded-sm text-sm px-2 py-2 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                                เพิ่มลูกทัวร์
                            </button>
                        </div>
                    </div>
