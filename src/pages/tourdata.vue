          ...
          <div class="px-3 mb-5">
            <div class="flex justify-between">
              ...
              <a
                ...
                class="inline-flex text-blue-700 hover:underline dark:text-blue-500"
                ><svg
                  fill="none"
                  stroke="currentColor"
                  stroke-width="1.5"
                  ...
                  <div class="p-6 space-y-6">
                    <div>
                      ...
                      <div class="grid grid-cols-2 gap-2">
                        ...
                        <div>
                          หมายเหตุ: สบายตัวมากๆเลยนะ ถ้าไปอีกรอบ จะหาตัวท็อป
                        </div>
                      </div>
                    </div>
                    <hr />
      ...
      <div data-dial-init class="fixed right-6 bottom-6 group">
        ...
        >
          ...
          <div
            id="tooltip-copy"
            role="tooltip"
            class="absolute z-10 invisible inline-block w-29 px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700"
          >
            แก้ไขข้อมูลทัวร์
            <div class="tooltip-arrow" data-popper-arrow></div>
          </div>
