            ...
            <div class="px-2 mb-2">
              ...
              <div id="comment"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdowncommentButton">
                  <li>
                    <a href="#"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">จัดการร้านอาหาร</a>
                  </li>
                  <li>
                    <a href="#"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">จัดการสถานที่เที่ยว</a>
                  </li>
                  <li>
                    <a href="#"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">จัดการเส้นทาง</a>
                  </li>
                  <li>
                    <a href="#"
        ...
        <div class="p-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div class="px-3 mb-5">
            <div class="flex justify-between">
              ...
              <div data-dial-init class="flex group -mt-4 -mr-6">
                <div id="speed-dial-menu-horizontal" class="flex items-center hidden mr-4 space-x-2">
                  ...
                  <button type="button" data-tooltip-target="tooltip-comment-tour" data-tooltip-placement="top"
                    class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                  ...
                  <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="p-6 text-center">
                        ...
                        <NuxtLink href="/tour_ls" type="button"
            ...
            <div class="grid grid-cols-3 gap-2">
              ...
              <div>วันที่เดินทาง: {{ tourfiltered.datestart }} ถึง {{ tourfiltered.dateend }}</div>
              <div>จำนวน: {{ tourfiltered.day }} วัน {{ tourfiltered.night }} คืน</div>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              ...
              <tbody>
                <tr v-if="!tourfiltered.member.length">
                  <td :colspan="8" class="text-center text-xl pt-5">ไม่มีข้อมูล</td>
                </tr>
                            ...
                            <form action="#" >
                              <div class="grid gap-4 mb-4  sm:gap-6 sm:mb-5">
                                <div class="w-full">
                                  ...
                                  <input type="text" name="firstname" id="firstname"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    v-model="tour.name" placeholder="" required />
                                </div>
                              </div>
                              <div class="grid gap-4 mb- sm:gap-6 sm:mb-5">
                                <div class="w-full">
                                  <label for="firstname2"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อภาษา-สกุลอังกฤษ</label>
                                  <input type="text" name="firstname2" id="firstname2"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    v-model="tour.nameeng" placeholder="" required />
                                </div>
                              </div>
                              <div class="grid gap-4 mb-4 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                                <div class="sm:col-span-2">
                                ...
                                <div>
                                  ...
                                  <select id="gender"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                                    <option selected>{{ tour.gender }}</option>
                                    <option value="ชาย">ชาย</option>
                                    <option value="หญิง">หญิง</option>
                                    <option value="อื่นๆ">อื่นๆ</option>
                                  </select>
                              ...
                              <div class="grid gap-4 mb-4 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                                <div class="w-full">
                                  ...
                                  <input type="text" name="identification" id="identification"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                    v-model="tour.nationa" placeholder="" required />
                                </div>
