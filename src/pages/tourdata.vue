<template>
  <section class="dark:bg-gray-900 p-3 sm:p-5">
    <div class="mx-auto max-w-screen-xl">
      <div>
        ...
        <div class="grid grid-cols-2">
          ...
          <div class="flex justify-end">
            <div class="px-2 mb-2">
              <button id="dropdowncommentButton" data-dropdown-toggle="comment"
                ...
                type="button">
                จัดการคอมเมนต์
                <svg class="w-5 h-5 ml-2" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"
              ...
              <div id="comment"
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdowncommentButton">
                  <li>
                    <a data-modal-target="cm_restaurant" data-modal-toggle="cm_restaurant"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">คอมเมนต์ร้านอาหาร</a>
                  </li>
                  <li>
                    <a data-modal-target="cm_location" data-modal-toggle="cm_location"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">คอมเมนต์สถานที่เที่ยว</a>
                  </li>
                  <li>
                    <a data-modal-target="cm_path" data-modal-toggle="cm_path"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">คอมเมนต์เส้นทาง</a>
                  </li>
                  <li>
                    <a data-modal-target="cm_hotel" data-modal-toggle="cm_hotel"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">คอมเมนต์โรงแรม</a>
                  </li>
                </ul>
              </div>
            </div>
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
                  <li>
                    <button id="doubleDropdownButton" data-dropdown-toggle="doubleDropdown"
                      ...
                      ใบเบิกค่าใช้จ่าย<svg aria-hidden="true" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div id="doubleDropdown"
                      ...
                      <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="doubleDropdownButton">
                        <li>
                          <a href="/add-estimate"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">สร้างใบเบิกค่าใช้จ่าย</a>
                        </li>
                        <li>
                          <a href="/disbursement-management"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">จัดการใบเบิกค่าใช้จ่าย</a>
                        </li>
                      </ul>
                    </div>
                  </li>
                  <li>
                    <button id="quotationDropdownButton" data-dropdown-toggle="quotationDropdown"
                      data-dropdown-placement="right-start" type="button"
                      class="flex items-center justify-between w-full px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                      ใบเสนอราคา<svg aria-hidden="true" class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                          d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
                          clip-rule="evenodd"></path>
                    ...
                    <div id="quotationDropdown"
                      class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                      <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="quotationDropdownButton">
                        <li>
                          <a href="/quotationForm"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">สร้างใบเสนอราคา</a>
                        </li>
                        <li>
                          <a href="/quotation-management"
                            class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">จัดการใบเสนอราคา</a>
                        </li>
                      </ul>
                    </div>
                  </li>
        ...
        <div class="p-8 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
          <div class="px-3 mb-5">
            <div class="flex justify-between">
              ...
              <div data-dial-init class="flex group -mt-4 -mr-6">
                <div id="speed-dial-menu-horizontal" class="flex items-center hidden mr-4 space-x-2">
                  <button data-modal-target="tourdataModal" data-modal-toggle="tourdataModal" type="button"
                    data-tooltip-target="tooltip-alldatatour" data-tooltip-placement="top"
                    class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-7 h-7 -ml-px">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z">
                      </path>
                    </svg>
                    <span class="sr-only">รายละเอียดทั้งหมด</span>
                  </button>
                  <div id="tooltip-alldatatour" role="tooltip"
                  ...
                  <!-- data tour modal -->
                  <div id="tourdataModal" tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative w-full max-w-4xl max-h-full">
                      ...
                      <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 space-y-6">
                          <div>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                              <div class="col-span-2">
                                ชื่อทริปทัวร์: องค์การบริหารส่วนตำบลโพนงาม
                              </div>
                              <div>โปรแกรมทัวร์: กาญจนบุรี-เพชรบุรี</div>
                              <div>
                                วันที่เดินทาง: 29/03/2566 ถึง 29/03/2566
                              </div>
                              <div>จำนวน: 4 วัน 2 คืน</div>
                              <div>จำนวนลูกทัวร์: 3 คน</div>
                              <div>
                                หมายเหตุ: สบายตัวมากๆเลยนะ ถ้าไปอีกรอบ
                                จะหาตัวท็อป
                              </div>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div class="grid grid-cols-3 gap-2">
                              ...
                              <div>โรงแรมเอเชีย ชะอำ</div>
                              <div>วันที่เช็คอินน์: 31/03/2566</div>
                              <div>วันที่เช็คเอ้าท์: 01/04/2566</div>
                              <div class="col-span-3 mb-1">
                                จำนวนห้องพัก: 45
                              </div>
                            </div>
                        ...
                        <div
                          ...
                          <button data-modal-hide="tourdataModal" type="button"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-10 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            ปิด
                          </button>
                        </div>
                      </div>
                  ...
                  <button type="button" data-modal-target="cm_tour" data-modal-toggle="cm_tour"
                    class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                    ...
                    <span class="sr-only">เขียนคอมเมนต์ทัวร์</span>
                  </button>
                  <div id="tooltip-comment-tour" role="tooltip"
                    class="absolute z-10 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    เขียนคอมเมนต์ทัวร์
                    <div class="tooltip-arrow" data-popper-arrow></div>
                  </div>
                  <NuxtLink href="/edittour" type="button" data-tooltip-target="tooltip-edittour"
                    ...
                    <span class="sr-only">แก้ไขหรือเพิ่มข้อมูล</span>
                  </NuxtLink>
                  <div id="tooltip-edittour" role="tooltip"
                    class="absolute z-10 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    แก้ไขหรือเพิ่มข้อมูล
                    <div class="tooltip-arrow" data-popper-arrow></div>
                  </div>
                  <button data-modal-target="deletetour" data-modal-toggle="deletetour" type="button"
                    data-tooltip-target="tooltip-delete" data-tooltip-placement="top"
                    class="flex justify-center items-center w-[52px] h-[52px] text-red-500 hover:text-red-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 dark:hover:text-white shadow-sm dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400">
                    <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <span class="sr-only">ลบทัวร์นี้</span>
                  </button>
                  <div id="tooltip-delete" role="tooltip"
                    class="absolute z-10 invisible inline-block w-auto px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-red-600 rounded-lg shadow-sm opacity-0 tooltip dark:bg-gray-700">
                    ลบทัวร์นี้
                    <div class="tooltip-arrow" data-popper-arrow></div>
                  </div>
                </div>

                <div id="deletetour" tabindex="-1"
                  ...
                  <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                      ...
                      <div class="p-6 text-center">
                        ...
                        <NuxtLink href="/tour_ls1" type="button"
                          class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-10 py-2.5 text-center mr-2">
                          ลบ
                        </NuxtLink>
                        <button data-modal-hide="deletetour" type="button"
                          class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-8 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                          ยกเลิก
                        </button>
                      </div>
                    </div>
            ...
            <div class="grid grid-cols-3 gap-2">
              <div>ชื่อทริปทัวร์: {{ tourfiltered.tourname }}</div>
              <div>โปรแกรมทัวร์: {{ tourfiltered.programname }}</div>
              <div>
                วันที่เดินทาง: {{ tourfiltered.datestart }} ถึง
                {{ tourfiltered.dateend }}
              </div>
              <div>
      ...
      <!-- ตารางลูกทัวร์ -->
      <div
        class="mt-9 block max-w-full p-2 pb-5 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="mt-3">
          <span class="mt-5 px-4 text-2xl font-bold text-gray-900 dark:text-white">
            ลูกทัวร์ทั้งหมด
          </span>
        </div>

        <div class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4 mb-2">
            ...
            <form class="flex items-center">
              <div class="relative w-full">
                ...
                <input type="text" id="simple-search"
                  ...
                  placeholder="ค้นหาลูกทัวร์" required="" />
              </div>
            </form>
          </div>
          <div class="mt-8 flex justify-end mb-4">
            <!-- Modal toggle -->
            <button>
              <NuxtLink data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" type="button"
            ...
            <NuxtLink href="/paper/sticker" type="button"
                      ...
                      <div class="grid gap-4 mb-4 sm:grid-cols-4 sm:gap-6 sm:mb-5">
                        ...
                        <div class="w-full">
                          <label for="startenddate"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">วันออกบัตร</label>
            ...
            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <thead class="text-xs text-gray-700 uppercase bg-gray-200 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                  ...
                  <th scope="col" class="px-6 py-3 text-center">เพิ่มเติม</th>
                </tr>
              </thead>
              <tbody>
                <tr v-if="!tourfiltered.member.length">
                  <td :colspan="8" class="text-center text-xl pt-5">
                    ไม่มีข้อมูล
                  </td>
                </tr>
                <tr v-for="(tour, index) in tourfiltered.member" key="indexm"
                  ...
                  <td class="px-6 py-4">{{ tour.idencard }}</td>
                  <td class="px-6 py-4">{{ tour.passport }}</td>
                  <td class="px-6 py-4">{{ tour.nationa }}</td>
                  <td class="px-6 py-4">{{ tour.gender }}</td>
                  <td class="px-6 py-4">{{ tour.bedtype }}</td>
                  <td class="px-6 py-4 flex justify-between">
                    <!-- Modal toggle -->
                    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-modal-target="staticModal"
                      data-modal-toggle="staticModal" class="w-5 h-5 text-gray-500 hover:text-gray-800">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z">
                      </path>
                    </svg>
                    ...
                    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-modal-target="editModal"
                      data-modal-toggle="editModal" class="w-5 h-5 text-blue-500 hover:text-blue-800">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10">
                      </path>
                    </svg>
                    ...
                    <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"
                      xmlns="http://www.w3.org/2000/svg" aria-hidden="true" data-modal-target="delete-modal"
                      data-modal-toggle="delete-modal" class="w-5 h-5 text-red-500 hover:text-red-800">
                      <path stroke-linecap="round" stroke-linejoin="round"
                        d="M14.74 9l-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 01-2.244 2.077H8.084a2.25 2.25 0 01-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 00-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 013.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 00-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 00-7.5 0">
                      </path>
                    </svg>
                      ...
                      <div class="relative w-full h-full max-w-2xl md:h-auto">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <form class="space-y-6" action="#">
                              ...
                              <div class="relative">
                                ...
                                <input datepicker datepicker-autohide type="text"
                                  class="p-2.5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                  placeholder="เลือกวันที่">
                              ...
                              <div>
                                <label for="name"
                                  class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อเรื่อง</label>
                                <input type="text" name="name" id="name"
                                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                  placeholder="หัวข้อเรื่อง" required />
                              </div>
                              <div>
                                ...
                                <textarea id="message" rows="4"
                                  ...
                                  placeholder="เขียนแสดงความคิดเห็น"></textarea>
                          ...
                          <div
                            ...
                            <button data-modal-hide="cm_restaurant" type="button"
                      ...
                      <div class="relative w-full max-w-md max-h-full">
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                          ...
                          <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                              ต้องการลบรายชื่อ
                              <p class="text-black underline">มะยม ขมจัง</p>
                            </h3>
    ...
    <!-- คอมเมนต์ร้านอาหาร -->
    <div id="cm_restaurant" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          <div class="p-6 space-y-6">
            <form class="space-y-6" action="#">
              ...
              <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">ชื่อเรื่อง</label>
                <input type="text" name="name" id="name"
                  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                  placeholder="หัวข้อเรื่อง" required />
              </div>
    ...
    <!--end คอมเมนต์ร้านอาหาร -->

    <!-- คอมเมนต์สถานที่ท่องเทียว -->
    <div id="cm_location" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <!-- Modal header -->
          ...
          <div
            class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="cm_location" type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              เพิ่มคอมเมนต์
            </button>
            <button data-modal-hide="cm_location" type="button"
    ...
    <!--end คอมเมนต์สถานที่ท่องเทียว -->

    <!-- คอมเมนต์เส้นทาง -->
    <div id="cm_path" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <!-- Modal header -->
          ...
          <div
            class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="cm_path" type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              เพิ่มคอมเมนต์
            </button>
            <button data-modal-hide="cm_path" type="button"
    ...
    <!-- คอมเมนต์โรงแรม -->
    <div id="cm_hotel" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <!-- Modal header -->
          ...
          <div
            class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="cm_hotel" type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              เพิ่มคอมเมนต์
            </button>
            <button data-modal-hide="cm_hotel" type="button"
    ...
    <!-- คอมเมนต์ทัวร์ -->
    <div id="cm_tour" tabindex="-1" aria-hidden="true"
      class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative w-full max-w-lg max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          <!-- Modal header -->
          ...
          <div
            class="flex justify-end items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button data-modal-hide="cm_tour" type="button"
              class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              เพิ่มคอมเมนต์
            </button>
            <button data-modal-hide="cm_tour" type="button"
