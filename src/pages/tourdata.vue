  ...
  <section class="dark:bg-gray-900 p-3 sm:p-5">
    <div class="mx-auto max-w-screen-xl">
            ...
            <div class="px-2 mb-2">
              ...
              >
                ...
                >
                  <li>
                    <a
                      data-modal-target="cm_restaurant"
                      data-modal-toggle="cm_restaurant"
                  ...
                  <li>
                    <a
                      data-modal-target="cm_location"
                      data-modal-toggle="cm_location"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >คอมเมนต์สถานที่เที่ยว</a
                    >
                  </li>
                  <li>
                    <a
                      data-modal-target="cm_path"
                      data-modal-toggle="cm_path"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >คอมเมนต์เส้นทาง</a
                    >
                  </li>
                  <li>
                    <a
                      data-modal-target="cm_hotel"
                      data-modal-toggle="cm_hotel"
                      class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >คอมเมนต์โรงแรม</a
                    >
                  </li>
            ...
            <div class="flex justify-between">
              ...
              <div data-dial-init class="flex group -mt-4 -mr-6">
                <div
                  ...
                  class="flex items-center hidden mr-4 space-x-2"
                >
                  <button
                    data-modal-target="tourdataModal"
                    data-modal-toggle="tourdataModal"
                    type="button"
                    data-tooltip-target="tooltip-alldatatour"
                  ...
                  <button
                    type="button"
                    data-modal-target="cm_tour"
                    data-modal-toggle="cm_tour"
                    class="flex justify-center items-center w-[52px] h-[52px] text-gray-500 hover:text-gray-900 bg-white rounded-full border border-gray-200 dark:border-gray-600 shadow-sm dark:hover:text-white dark:text-gray-400 hover:bg-gray-50 dark:bg-gray-700 dark:hover:bg-gray-600 focus:ring-4 focus:ring-gray-300 focus:outline-none dark:focus:ring-gray-400"
                  >
                    <svg
                      fill="none"
          ...
          <div class="grid grid-cols-3 gap-2 mt-5">
            <div class="px-3">
              <div href="#">
                ...
                <div
                  v-for="(hotel, indexh) in tourfiltered.hotel"
                  key="indexh"
                  class="grid grid-cols-3 gap-2"
                >
                  <div class="col-span-2">
                    โรงแรม: {{ findnameHotel(hotel.hotel_id) }}
                  </div>
            ...
            <div class="border-l-1 px-3">
              ...
              <div
                v-for="(guide, indexg) in finddataGuide()"
                key="indexg"
            ...
            <div class="border-l-1 px-3">
              ...
              <div class="grid grid-cols-3 gap-2">
                ...
                <div>พาหนะขากลับ :</div>
                <div
                  v-for="go in vehiclecheck('ขากลับ')"
      ...
      >
        <div class="mt-3">
          <span
            class="mt-5 px-4 text-2xl font-bold text-gray-900 dark:text-white"
          >
            ลูกทัวร์ทั้งหมด
          </span>
        </div>
        ...
        <div
          class="flex-row items-center justify-between p-4 space-y-3 sm:flex sm:space-y-0 sm:space-x-4 mb-2"
        >
                      ...
                      >
                        ...
                        <div class="w-full">
                          ...
                          <input
                            ...
                            name="check"
                            id="check"
                            v-model="memberdata.stampnumber"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                            placeholder=""
                            required
                          />
                          ...
                          <div date-rangepicker class="flex items-center">
                            <div class="w-full relative">
                              ...
                              <input
                                name="start"
                                type="text"
                                v-model="memberdata.dateofissue"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                          ...
                          <div date-rangepicker class="flex items-center">
                            <div class="w-full relative">
                              ...
                              <input
                                name="end"
                                type="text"
                                v-model="memberdata.dateofexpiry"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="เลือกวันที่"
                              />
                            </div>
                ...
                >
                  ...
                  <td class="px-6 py-4 flex justify-between">
                    ...
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      aria-hidden="true"
                      data-modal-target="customer_detail"
                      data-modal-toggle="customer_detail"
                        ...
                        >
                          ...
                          >
                            ...
                            <button
                              type="button"
                              class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                              data-modal-hide="customer_detail"
                            >
                              <svg
                                class="w-5 h-5"
                                fill="currentColor"
                          ...
                          <div class="p-6 space-y-6 text-left">
                            <div class="grid grid-cols-2 gap-4">
                              ...
                              >
                                ชื่อ-นามสกุล (ไทย): มะยม ขมจัง
                              </p>
                              <p
                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                              >
                                ชื่อ-นามสกุล (อังกฤษ): Mayom khomjung
                              </p>
                              <p
                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                              >
                              ...
                              <p
                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                              >
                                หมายเลขบัตรประชาชน: 1338899543256
                              </p>
                              <p
                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                              >
                                หมายเลขพาสปอร์ต: 1665542872
                              </p>
                              <p
                                class="text-base leading-relaxed text-gray-500 dark:text-gray-400"
                              >
                      ...
                      <div class="relative w-full max-w-2xl max-h-full">
                        ...
                        >
                          ...
                          <div class="px-6 py-6 lg:px-8">
                            ...
                            <form
                              class="space-y-6 flex justify-center"
                              action="#"
                            >
                              <button
                                type="button"
