        ...
        <form>
          <div class="grid gap-4 mb-4 grid-cols-5 mt-5">
            <div>
              <button
                type="button"
                data-modal-target="addvechicle"
                data-modal-toggle="addvechicle"
                ...
                <tbody>
                  ...
                  >
                    ...
                    <td class="flex px-6 py-4">
                      <p
                        class="mr-5 font-medium text-blue-600 dark:text-blue-500 hover:underline"
                        data-modal-toggle="editvechicle_page"
                      >
                        แก้ไข
                      </p>
                      <p
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            ...
            <button
              ...
              data-modal-target="newaddvechicle"
              data-modal-hide="addvechicle"
            >
              <svg
                class="w-5 h-5"
                fill="currentColor"
          ...
          <div class="p-6 space-y-6">
            <div class="grid-cols-3 gap-4 flex justify-between">
              ...
              <button
                type="button"
                data-modal-toggle="newaddvechicle"
                data-modal-hide="addvechicle"
              ...
              >
                ...
                <tbody>
                  <tr
                    ...
                    data-modal-toggle="detailvechicle"
                    data-modal-hide="addvechicle"
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                  >
                    <td class="w-4 p-4">
                    ...
                    <td class="px-6 py-4">3 คัน</td>
                    <td class="px-6 py-4">พาหนะขาไป</td>
                  </tr>
                  <tr
                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
                  >
                    ...
                    <td class="px-6 py-4">พาหนะขาไปและขากลับ</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        >
          ...
          >
            ...
            <button
              type="button"
              class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
              data-modal-hide="newaddvechicle"
              data-modal-toggle="addvechicle"
            >
              <svg
                aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
          ...
          >
            ...
            <button
              type="button"
              class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
              data-modal-hide="detailvechicle"
              data-modal-toggle="addvechicle"
            >
              <svg
                aria-hidden="true"
