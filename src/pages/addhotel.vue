    ...
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5">
        <div class="max-w-screen-lg mx-auto">
            <div class="block w-full p-6 bg-white border border-gray-200 rounded-lg shadow">
                ...
                <h1 class="mb-3 text-2xl tracking-tight text-gray-900 dark:text-white mt-5">
                    ข้อมูลโรงแรมที่พัก
                </h1>
                ...
                <form>
                    ...
                    <div class="flex justify-end ">
                        <button type="button"
                            class="mt-3 px-18 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">บันทึกข้อมูล</button>
