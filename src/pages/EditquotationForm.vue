    ...
    <section class="bg-gray-100 dark:bg-gray-900 p-3 sm:p-5">
      <div class="mx-auto max-w-screen-lg">
        ...
        >
          ...
          <hr class="h-px my-3 bg-gray-200 border-0 dark:bg-gray-700" />
          <h2 class="mb-4 text-xl text-gray-900 dark:text-white">ใบเสนอราคา/ยืนยันการสั่งซื้อ</h2>
          <form action="#">
          ...
          <div class="flex justify-end">
            ...
            <NuxtLink
              ...
              class="mt-3  px-18 py-2.5 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
            >
              ย้อนกลับก่อนหน้า
            </NuxtLink>
            ...
            <NuxtLink
              to="/tour_ls"
              class="mt-3 ml-5 px-18 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
            >
              แก้ไขใบเสนอราคา
            </NuxtLink>
